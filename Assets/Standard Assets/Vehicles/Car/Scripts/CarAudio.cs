        ...
        private void Update()
        {
            ...
            if (m_StartedSound)
            {
                ...
                if (engineSoundStyle == EngineAudioOptions.Simple)
                {
                    ...
                    m_HighAccel.volume = 1 * UserVolume;
                }
                else
                {
                    ...
                    // m_LowAccel.volume = (lowFade*accFade) * UserVolume;
                    // m_LowDecel.volume = (lowFade*decFade) * UserVolume;
                    // m_HighAccel.volume = (highFade*accFade) * UserVolume;
                    // m_HighDecel.volume = (highFade*decFade) * UserVolume;

                    m_LowAccel.volume = UserVolume;
                    m_LowDecel.volume = UserVolume;
                    m_HighAccel.volume = UserVolume;
                    m_HighDecel.volume = UserVolume;
