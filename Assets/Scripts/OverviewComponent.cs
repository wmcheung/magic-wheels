...
public class OverviewComponent : MonoBehaviour {
	...
	public void playerClick(GameObject[] items, Button clicked) {
		...
		foreach (GameObject item in items) {
			...
			if (button.Equals (clicked)) {
				...
				clicked.GetComponent<PlayerSelectorSwitcher> ().switcher (item, this.GetComponent<PlayersSelectHandler>().addFriendPanel);
	...
	public void deletePlayerClick(GameObject[] items, Button clicked) {
		...
		foreach (GameObject item in items) {
			...
			if (button.Equals (clicked)) {
				...
				clicked.GetComponent<PlayerSelectorSwitcher> ().deleteSwitcher (item);
